...
Your app is available to anyone on the internet as `your-app.xxx.mykube.app` . People just need a link to reach it. We route the traffic to your app through our own proxy, so you don't have to open any ports or set up DNS, and your home IP is not revealed.
...
## For advanced users: set it up yourself for better control and performance.
...
- Exposing your service as NodePort/Ingress/HttpRoute
- Configuring your router to forward port 443 to your nodePort/IngressService/GatewayService
